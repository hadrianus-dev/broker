    ...
    <div class="card shadow-lg ">
        <div class="card-header pb-0 pt-3 ">
            <div class="float-start">
                <h5 class="mt-3 mb-0">Cofigurações do Painel</h5>
                <p>Outras formas de ver o Dashboard.</p>
            </div>
        ...
        <div class="card-body pt-sm-3 pt-0">
            <!-- Sidebar Backgrounds -->
            <div>
                <h6 class="mb-0">Cor do Menú Lateral</h6>
            </div>
            ...
            <!-- Sidenav Type -->
            <div class="mt-3">
                <h6 class="mb-0">Como quer Navegar o Menú Lateral</h6>
                <p class="text-sm">Escolha entre estes dois modos.</p>
            </div>
            <div class="d-flex">
