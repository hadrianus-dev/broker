<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            ...
            <span class="ms-1 font-weight-bold">Alfregest Dashboard</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Opções de Gerênciamento</h6>
            </li>
            <li class="nav-item">
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="text-white up mb-0">Precisa de AAjuda?</h6>
                    <p class="text-xs font-weight-bold">Por favor, Verifica a documentação</p>
                    <a href="/documentation/bootstrap/overview/soft-ui-dashboard/index.html" target="_blank"
                        class="btn btn-white btn-sm w-100 mb-0">Documentação</a>
                </div>
            </div>
        </div>
    </div>
