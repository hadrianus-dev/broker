...
<head>
    ...
    @if(env('IS_DEMO'))
        ...
        <meta  itemprop="name" content="Alfregest" />
        ...
        <meta  name="twitter:site" content="@alfregest" />
        <meta  name="twitter:title" content="Alfregest Panel" />
        <meta  name="twitter:description" content="Painel Alfregest" />
        <meta  name="twitter:creator" content="@alfregest" />
    ...
    <!-- Fonts and icons     -->
    <link href="../assets/fonts/fontes.css" rel="stylesheet" />
    ...
    <!-- Alpine -->
    <script src="../assets/js/apline.js" defer></script>
